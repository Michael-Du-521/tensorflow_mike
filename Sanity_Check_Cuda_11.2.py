...
- Could not load 'msvcp140.dll'. You may install this DLL by downloading Microsoft Visual
  ...
  https://www.microsoft.com/en-us/download/details.aspx?id=53587""")
    ...
    try:
        cudart64_110 = ctypes.WinDLL("cudart64_110.dll")
        cudart64_110_path = find_library("cudart64_110.dll")
        print('- Cuda 11.2 found at {}'.format(cudart64_110_path))
        ## TODO: Look for version.txt file in CUDA path
    except OSError:
        candidate_explanation = True
        print("""
- Could not load 'cudart64_110.dll'. Download and install CUDA 11.2 from
...
- Could not load 'nvcuda.dll'. The GPU version of TensorFlow requires that
  ...
  correct driver installed.""")
    ...
    cudnn8_found = False
    try:
        cudnn8 = ctypes.WinDLL("cudnn64_8.dll")
        cudnn8_path = find_library("cudnn64_8.dll")
        print("- cuDNN Found at {}".format(cudnn8_path))
        cudnn7_found = True
    except OSError:
        candidate_explanation = True
        print("""
- Could not load 'cudnn64_8.dll'. The GPU version of TensorFlow
